...
from triple_barrier import signals
...
def show_results(wallet):
    ...
    print("Total return : {}%".format((total_return*100).round(2)))
...
def plot(close,barrier,wallet):   
    ...
    fig.update_layout(title_text='Now having cash + stock value = {}, Total gain rate = {}%'.format(total_asset.round(2),(total_return*100).round(2)))
